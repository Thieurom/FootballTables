...
public class MyTeamsDashboardViewController: StoreViewController<MyTeamsDashboardView.State, MyTeamsDashboardView.ViewState, MyTeamsDashboardView.Action> {

    // MARK: - Views

    public lazy var placeholderView = MessageView().apply {
        $0.titleLabel.textColor = .gray
        $0.imageView.tintColor = .gray
    }

    public lazy var tableView = UITableView(frame: .zero, style: .insetGrouped).apply {
