...
import SectionHeaderView
import Theme
import UIKit

public class StandingDashboardViewController: StoreViewController<StandingDashboardView.State, StandingDashboardView.ViewState, StandingDashboardView.Action> {
    ...
    public lazy var standingTableView = UITableView(frame: .zero, style: .insetGrouped).apply {
