...
public class MatchViewCell: StoreTableViewCell<MatchViewState, MatchViewCell.Action> {
    public static let identifier = "MatchViewCell"
    ...
    public static let reducer = Reducer<MatchViewState, Action, Void> { state, action, _ in
        switch action {
        case .selected:
            return .none
        }
    ...
    public lazy var matchDayLabel = UILabel().apply {
        $0.numberOfLines = 1
    ...
    public lazy var homeTeamNameLabel = UILabel().apply {
        $0.numberOfLines = 2
    ...
    public lazy var awayTeamNameLabel = UILabel().apply {
        $0.numberOfLines = 2
        $0.lineBreakMode = .byWordWrapping
        $0.font = .systemFont(ofSize: 16, weight: .medium)
        $0.textColor = .black
    ...
    public lazy var scoreLabel = UILabel().apply {
        $0.numberOfLines = 1
