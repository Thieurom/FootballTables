...
public class TeamViewController: StoreViewController<TeamView.State, TeamView.ViewState, TeamView.Action> {
    ...
    public lazy var matchesTableView = UITableView().apply {
