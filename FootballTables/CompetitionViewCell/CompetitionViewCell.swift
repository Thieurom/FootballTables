...
class CompetitionViewCell: StoreTableViewCell<CompetitionViewState, CompetitionViewCell.Action> {
    static let identifier = "CompetitionViewCell"
    ...
    lazy var logoImageView = UIImageView().apply {
